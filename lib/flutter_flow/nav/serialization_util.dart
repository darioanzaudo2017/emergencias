    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case VehiculosRow:
            return VehiculosRow(data);
          case VistaConteoPedidosPorEstadoRow:
            return VistaConteoPedidosPorEstadoRow(data);
          case DetalledePedidoRow:
            return DetalledePedidoRow(data);
          case PersonasRow:
            return PersonasRow(data);
          case BarriosRow:
