                      ...
                      children: [
                        Align(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/images/Identidad_LaSecre_PSDH-01.png',
                              width: 400.0,
                              height: 250.0,
                              fit: BoxFit.cover,
                            ),
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 8.0, 0.0, 24.0),
                                    child: Text(
                                      'Es Necesario crear Una Cuenta para Comenzar',
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        ScaffoldMessenger.of(context)
                                          ...
                                          SnackBar(
                                            content: Text(
                                              'Tu Cuenta fue creada con exito!! El Administrador te asignara un Rol.',
                                              style: TextStyle(
                                                color:
                                                    FlutterFlowTheme.of(context)
                                                        .primaryText,
                                            ...
                                            backgroundColor: const Color(0xFF39D25F),
                                          ),
                                        );

                                        context.goNamedAuth(
                                            'EstadoPedidos', context.mounted);
                                      },
                                      text: 'Crear Cuenta',
