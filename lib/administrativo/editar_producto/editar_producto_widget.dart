...
class _EditarProductoWidgetState extends State<EditarProductoWidget> {
  ...
  void initState() {
    ...
    _model.textNecesidadTextController ??=
        TextEditingController(text: widget.editarproducto?.necesidad);
    _model.textNecesidadFocusNode ??= FocusNode();

    _model.switchValue = widget.editarproducto!.estado!;
                              ...
                              Stack(
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.asset(
                                      'assets/images/Captura_de_pantalla_2024-11-28_120840.png',
                                      width: double.infinity,
                                      height: 340.0,
                                      fit: BoxFit.cover,
                                    ),
                                    ...
                                    children: [
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                .textNecesidadTextController,
                                            focusNode:
                                                _model.textNecesidadFocusNode,
                                            autofocus: false,
                                            obscureText: false,
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            await ProductosTable().delete(
                                              matchingRows: (rows) =>
                                                  rows.eqOrNull(
                                                'id',
                                                widget.editarproducto?.id,
                                              ),
                                            );
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          if (_model.dropRubroValue == null) {
                                            return;
                                          }
                                          await ProductosTable().update(
                                            data: {
                                              'rubro': _model.dropRubroValue,
                                              'necesidad': _model
                                                  .textNecesidadTextController
                                                  .text,
