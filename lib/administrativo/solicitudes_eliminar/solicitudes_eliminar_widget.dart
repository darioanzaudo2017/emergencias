...
import 'solicitudes_eliminar_model.dart';
export 'solicitudes_eliminar_model.dart';
...
class SolicitudesEliminarWidget extends StatefulWidget {
  ...
  State<SolicitudesEliminarWidget> createState() =>
      _SolicitudesEliminarWidgetState();
}

class _SolicitudesEliminarWidgetState extends State<SolicitudesEliminarWidget> {
  late SolicitudesEliminarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SolicitudesEliminarModel());
                                            ...
                                            Expanded(
                                              child: FutureBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  final containerBuscarpedidosResponse =
                                                      snapshot.data!;
                                                    ...
                                                    child: Builder(
                                                      builder: (context) {
                                                        final listaPedidosSol =
                                                            containerBuscarpedidosResponse
                                                                .jsonBody
                                                                .toList();
