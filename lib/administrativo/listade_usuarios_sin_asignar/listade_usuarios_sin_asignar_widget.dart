...
class ListadeUsuariosSinAsignarWidget extends StatefulWidget {
  ...
  State<ListadeUsuariosSinAsignarWidget> createState() =>
      _ListadeUsuariosSinAsignarWidgetState();
}

class _ListadeUsuariosSinAsignarWidgetState
    extends State<ListadeUsuariosSinAsignarWidget> {
  late ListadeUsuariosSinAsignarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListadeUsuariosSinAsignarModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsuariosRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuariosRow> listadeUsuariosSinAsignarUsuariosRowList =
            snapshot.data!;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                'Lista de Usuarios sin Asignar Rol',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  listadeUsuariosSinAsignarUsuariosRowList
                                      .length
                                      .toString(),
                                  style: FlutterFlowTheme.of(context)
                                      .labelLarge
                            ...
                            child: Builder(
                              builder: (context) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemCount: listaUsuariosSinAsignar.length,
                                  itemBuilder:
                                      (context, listaUsuariosSinAsignarIndex) {
                                    final listaUsuariosSinAsignarItem =
