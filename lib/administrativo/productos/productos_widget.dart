  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ProductosRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductosRow> productosProductosRowList = snapshot.data!;
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          ...
                                          return FlutterFlowDataTable<
                                            ...
                                            dataRowBuilder: (listaProductosItem,
                                                    listaProductosIndex,
                                                    selected,
                                                    onSelectChanged) =>
                                                DataRow(
                                              color: WidgetStateProperty.all(
                                                listaProductosIndex % 2 == 0
                                                    ? FlutterFlowTheme.of(
                                                            context)
                                                        .secondaryBackground
                                                    : FlutterFlowTheme.of(
