...
class _EditarVehiculoWidgetState extends State<EditarVehiculoWidget> {
  ...
  void initState() {
    ...
    _model.textPatenteTextController ??=
        TextEditingController(text: widget.editarVehiculo?.patente);
    _model.textPatenteFocusNode ??= FocusNode();

    _model.textIdentificadorTextController ??=
        TextEditingController(text: widget.editarVehiculo?.nombre);
    _model.textIdentificadorFocusNode ??= FocusNode();

    _model.switchValue = widget.editarVehiculo!.estado!;
