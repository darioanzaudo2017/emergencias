                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    '       Para Crear una Solicitud Nueva debemos dirigirnos a la Barra lateral y dentro del Menú Principal seleccionamos \'Solicitudes\'. Una vez dentro de esta Página nos situamos en la esquina inferior derecha donde se encuentra un ícono con un símbolo \'+\', lo clickeamos y accedemos a la siguiente Pantalla.',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    '       Para Autorizar Pedidos sólo debemos dirigirnos a la Barra lateral dentro del Menú Principal y seleccionar \'Autorizar Pedidos, en esta Pantalla nos saldrán todos las Solicitudes que están Pendientes de Autorización solamente.\n      Para acceder a una solicitud clickeamos sobre el botón \'Ver Pedido\' y a continuación saldrá el detalle de la solicitud. Esta Sección sólo será visible para aquellos Usuarios que Posean un Rol Administrativo,, los demás roles del sistema no verán esta Sección.',
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                        .override(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    '       Para Asignar Pedidos sólo debemos dirigirnos a la Barra lateral dentro del Menú Principal y seleccionar \'Asignar Pedidos, en esta Pantalla nos saldrán todos las Solicitudes que están Listas para ser asignadas y continuar con el proceso de entrega.\n     En este formulario solamente debemos elegir el Pedido que queremos asignar y clickear sobre el botón Asignar, a continuación saldrá una hoja imprimible con el detalle de la solicitud.',
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                        .override(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    '      En la Sección Panel de Entregas podremos visualizar los Pedidos que están en proceso de entrega solamente. En este Panel podemos reimprimir un Memo si es necesario.\n      Si clickeamos en Ver Pedido podemos actualizar el estado de nuestra solicitud cargando los datos de quien fue el encargado del reparto, datos del vehículo y si el pedido fue entregado o no.',
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                        .override(
                          ...
                          Row(
                            ...
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.asset(
                                  'assets/images/Screenshot_Panel.png',
                                  width: MediaQuery.sizeOf(context).width * 0.7,
                                  height: 550.0,
                                  fit: BoxFit.fill,
                                ),
                          ...
                          Row(
                            ...
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.asset(
                                  'assets/images/Screenshot_Panel2.png',
                                  width: MediaQuery.sizeOf(context).width * 0.7,
                                  height: 550.0,
                                  fit: BoxFit.fill,
                                ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    '       Para consultar una solicitud en cualquiera de sus estados, nos podemos dirigir a la solapa de \'Solicitudes\' dentro del Menú Principal elegimos la solicitud deseada y hacemos click en el botón \'Ver Pedido\', la solicitud saldrá con un marco de color que hace referencia al estado en el que se encuentra la misma.',
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                        .override(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    '       En Cada una de las solapas de nuestro sistema, en la parte superior se encontrará un cuadro de dialogó con el nombre Buscar de Solicitud, a medida que vayamos escribiendo en este cuadro, se va a filtar el resultado en la tabla, se puede buscar por nombre o dni del beneficiario de la solicitud en todas las secciones del Sistema.',
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                        .override(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    '       La Referencia de Colores ayuda a la detección rápida de los estados de nuestras solicitudes, en el Formulario Estado de Pedidos al hacer click sobre el color además se llena una tabla con los registros que tienen el estado solicitado. En el Formulario Solicitudes al hacer click en Ver Pedido, en la Tarjeta Inicial tabién podemos ver el esquema de colores.',
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                        .override(
