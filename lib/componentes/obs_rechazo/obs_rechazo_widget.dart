...
export 'obs_rechazo_model.dart';

class ObsRechazoWidget extends StatefulWidget {
  const ObsRechazoWidget({
    super.key,
  ...
  @override
  State<ObsRechazoWidget> createState() => _ObsRechazoWidgetState();
}

class _ObsRechazoWidgetState extends State<ObsRechazoWidget>
    with TickerProviderStateMixin {
  late ObsRechazoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ObsRechazoModel());
