...
class EditarProductosWidget extends StatefulWidget {
  ...
  final DetalledePedidoRow? idDetalleProducto;
...
class _EditarProductosWidgetState extends State<EditarProductosWidget>
  ...
  void initState() {
    ...
    _model.txtRubroTextController ??=
        TextEditingController(text: widget.idDetalleProducto?.rubro);
    _model.txtRubroFocusNode ??= FocusNode();

    _model.txtNecesidadTextController ??=
        TextEditingController(text: widget.idDetalleProducto?.necesidad);
    _model.txtNecesidadFocusNode ??= FocusNode();

    _model.txtCantidadTextController ??= TextEditingController(
        text: widget.idDetalleProducto?.cantidad?.toString());
    _model.txtCantidadFocusNode ??= FocusNode();

    _model.txtObsTextController ??=
        TextEditingController(text: widget.idDetalleProducto?.observaciones);
          ...
          Padding(
            ...
            child: FutureBuilder<List<ProductosRow>>(
              ...
              builder: (context, snapshot) {
                ...
                List<ProductosRow> containerProductosRowList = snapshot.data!;
                          ...
                          children: [
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                focusNode: _model.txtRubroFocusNode,
                                autofocus: true,
                                readOnly: true,
                                obscureText: false,
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primary,
                                validator: _model
                                    .txtRubroTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                focusNode: _model.txtNecesidadFocusNode,
                                autofocus: true,
                                readOnly: true,
                                obscureText: false,
                                decoration: InputDecoration(
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primary,
                                validator: _model
                                    .txtNecesidadTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                            Padding(
                            ...
                            Align(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await DetalledePedidoTable().update(
                                    data: {
                                      'cantidad': int.tryParse(_model
                                          .txtCantidadTextController.text),
                                      'observaciones': valueOrDefault<String>(
                                        _model.txtObsTextController.text,
                                        '-',
                                      ),
                                    },
                                    matchingRows: (rows) => rows.eqOrNull(
                                      'id',
                                      widget.idDetalleProducto?.id,
                                    ),
                                  );
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Se Actualizo el Detalle de Producto',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryText,
                                        ),
