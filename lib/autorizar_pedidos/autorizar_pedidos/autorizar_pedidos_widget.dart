...
import 'autorizar_pedidos_model.dart';
export 'autorizar_pedidos_model.dart';
...
class _AutorizarPedidosWidgetState extends State<AutorizarPedidosWidget> {
  late AutorizarPedidosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AutorizarPedidosModel());
